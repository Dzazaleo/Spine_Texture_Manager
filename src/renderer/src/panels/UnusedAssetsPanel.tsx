 ...
 * query and onQueryChange are now required props; local query useState removed.
 * Phase 26.2 D-01 — panel is now tab-gated in AppShell (renders only when activeTab === 'unused').
 * Phase 26.2 D-07a — header icon converted to stroke standard (viewBox="0 0 20 20").
 */
  ...
  return (
    ...
    >
      <span
        ...
        aria-hidden="true"
      >
        {/* Phase 26.2 D-07a — stroke icon (viewBox="0 0 20 20", fill="none") */}
        <svg
          viewBox="0 0 20 20"
          fill="none"
          stroke="currentColor"
