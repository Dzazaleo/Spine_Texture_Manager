...
- [x] 08.1-06-PLAN.md — Close-out: automated exit-criteria sweep + 08.1-VALIDATION.md per-plan map + 3-reproducer manual UAT + ROADMAP.md plan-checkbox flips + STATE.md advance. Wave 5, has checkpoint, depends_on [08.1-01..05].
