...
- [ ] 44-01-PLAN.md — Wave 1: commit the ORCL-01 4.2-sibling + 3 owner 4.3 rigs (D-05), add buildLoadXtra01/02 to baseline-driver, bump CURRENT_PHASE 42->44 *(ORCL-01)*
...
| 44. Loader Dispatch + Equivalence Oracle + 4.3 Fixtures | v1.6 | 0/4 | Not started | - |
