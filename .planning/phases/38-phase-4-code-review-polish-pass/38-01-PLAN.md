...
```
  ...
  <verify>
    <automated>test -s .planning/phases/38-phase-4-code-review-polish-pass/38-POLISH-AUDIT.md && grep -c '^## IN-0[1-6]\|^## WR-03' .planning/phases/38-phase-4-code-review-polish-pass/38-POLISH-AUDIT.md | grep -qx 7 && grep -q 'milestones/v1.0-phases/04-scale-overrides/04-REVIEW.md' .planning/phases/38-phase-4-code-review-polish-pass/38-POLISH-AUDIT.md && grep -q 'GlobalMaxRenderPanel.tsx' .planning/phases/38-phase-4-code-review-polish-pass/38-POLISH-AUDIT.md && grep -q 'AnimationBreakdownPanel.tsx' .planning/phases/38-phase-4-code-review-polish-pass/38-POLISH-AUDIT.md && ! grep -q 'SearchBar.tsx' .planning/phases/38-phase-4-code-review-polish-pass/38-POLISH-AUDIT.md</automated>
  </verify>
  <acceptance_criteria>
    ...
    - IN-04 does NOT name SearchBar.tsx (corrects roadmap slip): `! grep -q 'SearchBar.tsx' .planning/phases/38-phase-4-code-review-polish-pass/38-POLISH-AUDIT.md`
