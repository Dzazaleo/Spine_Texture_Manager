...
**Progress:** Phase 36 (Split Overrides Per Loader Mode, OVR-01..07) — COMPLETE 2026-05-13. 5 plans, 14/14 must-haves verified, 1076 tests passing (+3 CR-01 main-side regression tests). SEED-007 closed.
...
- Long-lived todo burndown (Phase 4 code-review follow-up; Phase 20 Doc Builder Windows DnD UAT; Phase 31 Windows admin DnD release UAT — last two host-blocked, ship if Win host available)
