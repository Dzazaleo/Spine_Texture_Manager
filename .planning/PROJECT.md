...
**Target features:**
- Split overrides per loaderMode (SEED-007 — schema-additive, `overridesAtlasLess` field; legacy v1.3.x routing by saved `loaderMode`; mode-switch leaves inactive bucket untouched; decisions 1, 2-A, 3-A LOCKED)
